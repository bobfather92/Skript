...
5. **Import queue:** allow several Fountain, Final Draft, PDF and Word files to be selected together, with a clear review queue for formats that need import confirmation.
